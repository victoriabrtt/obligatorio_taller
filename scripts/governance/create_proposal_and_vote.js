// Script to create a proposal and vote as a specific user
...
async function main() {
  ...
  if (!userAddress) {
    ...
    console.error("Example: USER_ADDRESS=0x123... npx hardhat run scripts/governance/create_proposal_and_vote.js --network localhost");
    process.exit(1);
  }
